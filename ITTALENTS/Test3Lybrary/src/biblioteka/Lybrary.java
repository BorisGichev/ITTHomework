...
public class Lybrary {
	...
	public void getReadingMaterial(ReadingMaterial readingMaterial) throws LibraryException {
		if (readingMaterial != null && readingMaterial.canBetaken() && !readingMaterial.isTaken()) {
			...
			lybraryMan.addMaterialToWatch(readingMaterial);
	...
	public void setLybraryMan(LybraryMan lybraryMan) {
		this.lybraryMan = lybraryMan;
	}
	
	public void returnReadingMaterial(ReadingMaterial readingMaterial) {
		readingMaterial.takeIt(false);
		System.out.println("Money to give " + lybraryMan.getHowMuchIHaveToPayForThis(readingMaterial));
		lybraryMan.removeMaterialToWatch(readingMaterial);
